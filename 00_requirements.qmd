...
That said, you can follow [the first part of tutorial](01_basics.qmd) without the use of `git` or GitHub. We will assume that you have [`RStudio`](https://posit.co/products/open-source/rstudio/) available (installed or online). 
...
## `R` and RStudio online via Posit Cloud
...
**4. In the 'Build' tab, cleck 'configure build tools'.**
